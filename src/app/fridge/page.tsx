...
export default function FridgePage() {
  const [activeTab, setActiveTab] = useState<'전체' | '냉장' | '냉동' | '실온'>(
    '전체'
  );
  ...
  const handleAddItem = () => {
    const newItem: FridgeItem = {
      ...
      quantity: 1,
      storageLocation:
        activeTab === '전체' ? '냉장' : (activeTab as '냉장' | '냉동' | '실온'),
      isExpanded: true,
    };
      ...
      <section className={SECTION_PADDING}>
        ...
        >
          <TabsList className='grid w-full grid-cols-4 h-auto p-1'>
            <TabsTrigger
              value='전체'
              className='flex flex-col items-center justify-center gap-0.5 h-16 py-2 data-[state=active]:bg-white'
            >
              <Package className='w-5 h-5' />
              <span className='text-xs font-medium'>전체</span>
              <Badge
                variant='secondary'
                className='text-[10px] h-4 min-w-[20px] px-1.5 bg-gray-100 mt-0.5'
              >
                {items.length}
              </Badge>
            </TabsTrigger>
            ...
            >
              ...
              <span className='text-xs font-medium'>냉장</span>
              <Badge
                variant='secondary'
                className='text-[10px] h-4 min-w-[20px] px-1.5 bg-blue-100 text-blue-700 mt-0.5'
              >
            ...
            >
              ...
              <span className='text-xs font-medium'>냉동</span>
              <Badge
                variant='secondary'
                className='text-[10px] h-4 min-w-[20px] px-1.5 bg-purple-100 text-purple-700 mt-0.5'
              >
            ...
            >
              ...
              <span className='text-xs font-medium'>실온</span>
              <Badge
                variant='secondary'
                className='text-[10px] h-4 min-w-[20px] px-1.5 bg-orange-100 text-orange-700 mt-0.5'
              >
...
function FridgeItemCard({
  ...
  const getStorageIcon = () => {
    switch (storageLocation) {
      case '냉장':
        return <Refrigerator className='w-3 h-3' />;
      case '냉동':
          ...
          <div className='flex items-start gap-2'>
            <div className='flex-1 min-w-0'>
              {isNameEditing ? (
                ...
                <h3
                  className='font-semibold text-base text-gray-800 cursor-pointer hover:text-gray-600 transition-colors truncate'
          ...
          {!isExpanded && name && (
            <div className='flex items-center justify-between gap-2'>
              <div className='flex items-center gap-2 flex-wrap text-xs min-w-0'>
                <Badge
                  variant='secondary'
                  className={cn('text-xs', getStorageColor())}
                >
                  {getStorageIcon()}
                ...
                {expirationDate && (
                  <>
                    ...
                    <Badge
                      ...
                      className={cn('text-xs', getDDayColor())}
                    >
                      {getDDayText()}
                    </Badge>
                  </>
              ...
              <div className='flex items-center gap-1 flex-shrink-0'>
                ...
                <Button
                  ...
                  onClick={onDiscard}
                  className={cn(
                    'h-7 w-7 text-red-600 hover:text-red-700 hover:bg-red-50',
            ...
            <div>
              ...
              <div className='grid grid-cols-3 gap-2'>
                <Button
                  ...
                  className={cn(
                    'h-9 flex flex-col gap-1 py-1.5',
                    storageLocation === '냉장' &&
        ...
        {name && (
          <div className='flex justify-center mt-3 pt-2 border-t border-gray-100'>
            <Button
              ...
              className='text-xs text-gray-500 hover:text-gray-700 hover:bg-gray-50 h-7 px-3'
            >
              {isExpanded ? (
                <>
